...
<body>
	...
	<script>
		...
		*/
		...
		//대화명 설정 + 서버 연결
		const url = 'ws://192.168.10.48:8090/socket/chatserver.do';
		...
		function connect(name) {
			...
			this.name = name;
			//alert(this.name);//index.jsp에 chat
			//alert(window.name);//강아지
			...
			ws.onopen = evt => {
				...
				//객체 > JSON 표기법의 문자열로 변경하기
				//alert(JSON.stringify(message));
				//{"code":1,"sender":"병아리","receiver":"","content":"","regdate":"2024-10-24 12:33:46"}
