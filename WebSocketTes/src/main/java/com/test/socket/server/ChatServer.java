...
public class ChatServer {
	...
	public void handleMessage(String msg, Session session) {
		...
		//System.out.println(msg);//{"code":1,"sender":"병아리","receiver":"","content":"","regdate":"2024-10-24 12:33:46"}
		
		Gson gson = new Gson();
		
		Message message = gson.fromJson(msg, Message.class);
		
		System.out.println(message); //Message(code=1, sender=강아지, receiver=, content=, regdate=2024-10-24 12:39:47)
